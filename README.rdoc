...
- Webduino, Copyright (c) 2009, Ben Combee, Ran Talbott
...
- Arduino IDE v0022 + Arduino Uno
- Arduino IDE v0022 + Arduino Duemilanove
- Arduino IDE v0017 + Arduino Duemilanove

If you are using Arduino IDE version 0017, comment out the SPI.h library include
at the very top of the MyDoorOpener.pde file.
...
Besides the MyDoorOpener PDE file, there's a complete libraries tree included
